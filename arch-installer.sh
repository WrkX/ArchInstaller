...
install="
	archlinux-keyring arch-gaming-meta base base-devel blueman bluez-utils  bridge-utils  btop  cups discord  dnsmasq dunst fastfetch feh  firefox gamemode  gedit ghostscript gvfs hyprland inxi iwd  kitty kvantum libva-nvidia-driver libva-mesa-driver linux linux-firmware linux-headers lxappearance network-manager-applet noto-fonts noto-fonts-cjk noto-fonts-emoji os-prober otf-font-awesome pamixer papirus-icon-theme pavucontrol   polkit-kde-agent    rofi-wayland sddm sshfs thunar thunar-archive-plugin ttf-font-awesome ttf-iosevka-nerd ttf-jetbrains-mono tumbler udiskie unrar unzip vulkan-tools waybar wget   xarchiver xdg-desktop-portal-gtk xdg-desktop-portal-hyprland xdg-utils zathura zathura-pdf-mupdf zoxide zsh zsh-autosuggestions zsh-syntax-highlighting
"
aurinstall="
